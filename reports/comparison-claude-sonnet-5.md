# Old vs new grader — R01–R06 (V7 judge: `anthropic/claude-sonnet-5`)
...
V7 ran on `anthropic/claude-sonnet-5` (OpenRouter honesty check). See the Why column above for whether this model's votes changed any PASS/FAIL relative to the deterministic-only grade.
